...
- skopiujmy public IP naszego serwera, zróbmy sprawdzenie jak w poprzedniej wersji, czyli czy endpoint `/items` działa


## Deploy aplikacji Frontendowej
